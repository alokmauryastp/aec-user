...
class _CounsellingPageState extends State<CounsellingPage> {
  ...
  late List<AllCounselingData> allCounselingData = [];
  ...
  void initState() {
    ...
    Future future2 = counsellingRepo.counsellingApi(doctorId.isNull?"":doctorId);
    future2.then((value){
      setState(() {
        allCounselingData = value;
        print("ssssymptoms"+allCounselingData[0].title);
      });
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:  blogData.isEmpty?
             ...
             : SafeArea(
            child: allCounselingData.isNull?  Container(
              color: Colors.white,
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset("assets/images/notcounselling.jpg",width: Get.width,),
                  Text("Sorry! Counselling not available.",style: TextStyle(fontSize: 20,
                      color: AppColors.appbarbackgroundColor,
                      fontWeight: FontWeight.bold),),
                ],
              ),
            )
        : allCounselingData.isEmpty?
            Container(
              color: Colors.white,
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.builder(
              ...
              itemCount: allCounselingData.length,
              itemBuilder: (BuildContext context, index) {
                return Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Get.to(CounsellingDetailPage(),arguments: allCounselingData[index],
                          transition: Transition.rightToLeftWithFade,
                          duration: Duration(milliseconds: 600));
                    },
                    child: Container(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(allCounselingData[index].name,
