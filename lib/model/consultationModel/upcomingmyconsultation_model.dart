// @dart=2.9
class UpcomingConsultationModel {
  int status;
  String msg;
  List<UpcomingConsultationData> data;

  UpcomingConsultationModel({this.status, this.msg, this.data});

  UpcomingConsultationModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
    if (json['data'] != null) {
      data = new List<UpcomingConsultationData>();
      json['data'].forEach((v) {
        data.add(new UpcomingConsultationData.fromJson(v));
      });
    }
  }
...
class UpcomingConsultationData {
  String consultId;
  String patientName;
  String disease;
  String patientAge;
  ...
  UpcomingConsultationData.fromJson(Map<String, dynamic> json) {
